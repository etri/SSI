...
public class ClientUniResolver implements UniResolver {
	...
	public ResolveResult resolve(String identifier, Map<String, String> options) throws ResolutionException {
		...
		try {
			...
			throw new ResolutionException(/*ex.getMessage()*/ "UnsupportedEncodingException", ex);
		}
		...
		try (CloseableHttpResponse httpResponse = (CloseableHttpResponse) this.getHttpClient().execute(httpGet)) {
			...
			throw new ResolutionException("Cannot retrieve RESOLVE RESULT for " + identifier + " from " + uriString + ": " + /*ex.getMessage()*/"IOException" , ex);
		}
	...
	public Map<String, Map<String, Object>> properties() throws ResolutionException {
		...
		try (CloseableHttpResponse httpResponse = (CloseableHttpResponse) this.getHttpClient().execute(httpGet)) {
			...
			throw new ResolutionException("Cannot retrieve DRIVER PROPERTIES from " + uriString + ": IOException" /*+ ex.getMessage()*/, ex);
		}
