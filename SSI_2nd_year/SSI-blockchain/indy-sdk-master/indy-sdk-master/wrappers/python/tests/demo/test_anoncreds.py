...
async def test_anoncreds_demo_works(pool_name, path_home, wallet_config, credentials):
    ...
    prover_did = 'did:sov:VsKV7grR1BUE29mG2Fm2kX'
    ...
    cred_id = 'cred_id_1'
    await anoncreds.prover_store_credential(wallet_handle, cred_id, cred_req_metadata_json,
