...
impl ProverCommandExecutor {
    ...
    fn create_master_secret(&self,
        ...
        let master_secret = self.anoncreds_service.prover.new_master_secret(&master_secret_id)?;
        ...
        debug!("create_master_secret <<< master_secret_id: {:?}, master_secret: {:?}", master_secret_id, master_secret);
