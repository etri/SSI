...
//    }
    ...
    public void getPublicKey(PublicKeyListener publicKeyListener, String issuerDid, String keyid){
        Call<DIDDocVo> rtn = didResolverAPI.didResolverAPIInfo.getDIDData(issuerDid);
        rtn.enqueue(new Callback<DIDDocVo>(){
            @Override
            public void onResponse(Call<DIDDocVo> call, Response<DIDDocVo> response){
                PrintLog.e("response code = " + response.code());
