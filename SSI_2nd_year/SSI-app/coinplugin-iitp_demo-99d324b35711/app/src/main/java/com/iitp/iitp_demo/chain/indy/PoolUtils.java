...
import static com.iitp.iitp_demo.chain.indy.Indy.indyClientPath;


public class PoolUtils{

	static String POLLNAME = "default_pool";
	...
	public static File createGenesisTxnFile(String filename) throws IOException {
		...
		PrintLog.e("path = "+path);
		PrintLog.e("testPoolIp = "+testPoolIp);
...
//		PrintLog.e("genesis = "+defaultTxns[0]);
//		PrintLog.e("genesis = "+defaultTxns[1]);
//		PrintLog.e("genesis = "+defaultTxns[2]);
//		PrintLog.e("genesis = "+defaultTxns[3]);
	...
	public static String createPoolLedgerConfig() throws IOException, InterruptedException, java.util.concurrent.ExecutionException, IndyException{
		File genesisTxnFile = createGenesisTxnFile("genesis.txn");

		PrintLog.e("genesis txn = "+genesisTxnFile.getAbsolutePath());
		...
		PrintLog.e(createPoolLedgerConfigJSONParameter.toJson());
		Pool.createPoolLedgerConfig(POLLNAME, createPoolLedgerConfigJSONParameter.toJson()).get();
		return POLLNAME;
	}
