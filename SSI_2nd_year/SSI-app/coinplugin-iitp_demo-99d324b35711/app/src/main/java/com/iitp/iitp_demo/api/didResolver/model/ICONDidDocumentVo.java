...
public class ICONDidDocumentVo{
    ...
    @Expose
    public List<ICONPublicKeyVo> publicKey = null;
    ...
    public List<ICONPublicKeyVo> getPublicKey(){
        return publicKey;
    }

    public void setPublicKey(List<ICONPublicKeyVo> publicKey){
